...
const slides: Slide[] = [
  {
    ...
    description: 'Consulting Engineers and Management specialists in engineering and building diagnostics with full scope of work reports',
    image: 'https://images.pexels.com/photos/416405/pexels-photo-416405.jpeg',
    link: '/services#consulting'
  },
  {
    title: '24/7 Rapid Emergency Disaster Response',
    description: 'Commercial and residential make safe with a focus on quick response and minimal disruption',
    image: 'https://images.pexels.com/photos/209728/pexels-photo-209728.jpeg',
    link: '/services#emergency'
  },
  {
    title: 'Complete Insurance Claim Management',
    description: 'Comprehensive insurance claim support from assessment to completion',
