        ...
        <div className="container relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/80">
              Get in touch with our team for inquiries, quotes, or emergency
              assistance
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col items-center justify-between space-y-4 text-center md:flex-row md:text-left md:space-y-0">
            <div>
              ...
              <p className="text-dark">
                Need immediate assistance? Our emergency team is available
                around the clock.
              </p>
            </div>
            <a
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="fade-in">
              <div className="p-6 bg-white rounded-lg shadow-md h-full">
                ...
                <p className="mb-4">
                  We provide services throughout the Greater Sydney area and
